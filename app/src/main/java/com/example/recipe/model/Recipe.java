...
public class Recipe {
    ...
    public void updateSteps(int index, String step) {
    ...
    public String getRecipeDetails() {
        return "Recipe Name: " + this.getName() + "\n" +
                "Description: " + this.getDescription() + "\n" +
                "Serving Size: " + this.getServingSize() + "\n" +
                "Preparation Time: " + this.getPrepTime() + "\n" +
                "Ingredients: " + this.getIngredients() + "\n" +
                "Steps: " + this.getSteps() + "\n" +
                "Nutrition Info: " + this.getNutritionInfo();
    }

    public String getRecipeDetailsBrief() {
        return "Recipe Name: " + this.getName() + "\n" +
                "Description: " + this.getDescription() + "\n" +
                "Serving Size: " + this.getServingSize() + "\n" +
                "Preparation Time: " + this.getPrepTime() + "\n" +
